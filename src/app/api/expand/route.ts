...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    console.log("[rabbit-hole] [expand] nodeId:", nodeId, "mode:", mode, "budget:", budget);
    ...
    if (s2Id) {
      try {
        ...
        console.warn(
          "[rabbit-hole] [expand] S2 expansion failed; falling back to Exa:",
    ...
    console.log("[rabbit-hole] [expand] result: papers=", papers.length, "edges=", edges.length);
